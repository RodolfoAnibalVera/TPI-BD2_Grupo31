    ...
    public partial class Ofertas : System.Web.UI.Page
    {
        ...
        protected void btnAccionCommand(object sender, CommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Comprar")
            {
                ...
                LibroNegocio ofertas = new LibroNegocio();
                repOfertas.DataSource = ofertas.ListarOfertas();
                repOfertas.DataBind();
            }
        }
        ...
        protected void repOfertas_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var litOferta = (Literal)e.Item.FindControl("litOferta");
                ...
                // Mostrar insignia Oferta
                litOferta.Text = "<span class='badge bg-danger text-light position-absolute top-0 start-0 m-2'>Oferta</span>";
